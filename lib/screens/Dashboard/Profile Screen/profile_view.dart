...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    ...
    getUserData().then((value) => {
          if (value != null && value != "null")
            {userName = value.name, userEmail = value.email}
        });
    // });
  }
  ...
  Widget build(BuildContext context) {
    ...
    var fontStyle = const TextStyle(
        color: AppColor.black, fontSize: 14, fontFamily: AppFont.poppinsMedium);
    return Scaffold(
        body: Center(
      child: Column(
        children: [
          ...
          CustomButton(
            ...
            onPressed: () {
              Navigator.popAndPushNamed(context, AppScreen.editProfile);
            },
          ),
          SizedBox(
            height: 10,
          ...
          listTile(
              ...
              onPressed: () {
                Navigator.pushNamed(context, AppScreen.gameRate);
              }),
          listTile(
              title: Text(
                "Refer & Earn",
          ...
          listTile(
              ...
              onPressed: () {
                Navigator.popAndPushNamed(context, AppScreen.verifyScreen);
              }),
          listTile(
              title: Row(
                children: [
          ...
          listTile(
              ...
              onPressed: () {
                popUp(context: context, title: "Are you sure?", actions: [
                  TextButton(
                    onPressed: () {
